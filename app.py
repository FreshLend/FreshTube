...
def time_ago(upload_date):
    """Форматирование даты в относительный формат (например, "5 минут назад")"""
    now = datetime.now()
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000, debug=True) # ssl_context=("fullchain.crt", "certificate.key"),
